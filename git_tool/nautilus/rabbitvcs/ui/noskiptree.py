...
class Noskiptree(InterfaceView, GtkContextMenuCaller):
    ...
    def __init__(self, paths, base_dir=None):
        InterfaceView.__init__(self, "noskiptree", "Noskiptree")
    ...
    def on_file_make_toggled(self, widget):
        self.file_make = widget.get_active()
...
class SVNNoskiptree(Noskiptree):
    def __init__(self, paths, base_dir=None):
...
class GitNoskiptree(Noskiptree):
    def __init__(self, paths, base_dir=None):
        Noskiptree.__init__(self, paths, base_dir)
    ...
    def on_ok_clicked(self, widget):
        ...
        self.action.append(self.action.set_header, _("No Skiptree"))
        self.action.append(self.action.set_status, _("Running No Skiptree Command..."))
        self.action.append(self.git.noskiptree, items, self.file_make)
...
classes_map = {
    rabbitvcs.vcs.VCS_SVN: SVNNoskiptree,
    rabbitvcs.vcs.VCS_GIT: GitNoskiptree
}
